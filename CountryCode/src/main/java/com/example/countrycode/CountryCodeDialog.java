...
import com.example.countrycode.countrycodepicker.Country;
import com.example.countrycode.countrycodepicker.CountryCodeArrayAdapter;
...
public class CountryCodeDialog extends BottomSheetDialog {
    ...
    Context mBottomSheetContext;
    RecyclerView recyclerView;
    BottomSheetDataAdapter bottomSheetDataAdapter;
...
//
//
//            recyclerView = findViewById(R.id.bottom_sheet_rec_view);
//
//
...
//             //   this.dismiss();
//
//                bottomSheetDataAdapter = new BottomSheetDataAdapter(mBottomSheetContext, arrayList);
//                recyclerView.setAdapter(bottomSheetDataAdapter);
//                bottomSheetDataAdapter.notifyDataSetChanged();
//            }
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
